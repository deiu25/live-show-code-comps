  ...
  return (
    <div id="login-container">
      <form class="login-form">
        ...
        <input class="login-form-content" type="text" placeholder="Username" />
        <input class="login-form-content" type="password" placeholder="Password" />
        <button>Continue</button>
        <Link to="/forgot" className="forgot" id="forgot">Forgot Password?</Link>
        <Link to="/singup" className="signup" id="signup">Sign Up</Link>
